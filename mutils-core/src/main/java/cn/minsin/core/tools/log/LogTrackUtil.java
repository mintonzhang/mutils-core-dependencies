...
public class LogTrackUtil {
	 ...
	 */
	public static void track(@NonNull String message, Object... param) {
	 ...
	 */
	public static void beginTrack(@NonNull String message, Object... param) {
		log.info("开始轨迹追踪,当前时间:".concat(formatDate()).concat(LOG_SPLIT).concat(message), param);
	}

	/**
	 * 记录轨迹日志 自定义方法 实际是info
	 */
	public static void errorTrack(Throwable throwable, @NonNull String message, Object... param) {
	 ...
	 * 记录轨迹日志 自定义方法 实际是info
	 */
	public static void endTrack(@NonNull String message, Object... param) {
		log.info("结束轨迹追踪,当前时间:".concat(formatDate()).concat(LOG_SPLIT).concat(message), param);
	}
